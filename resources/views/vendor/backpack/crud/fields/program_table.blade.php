            ...
            <tbody class="table-striped items sortableOptions">
                ...
                <tr class="array-row clonable" style="display: none;">
                    ...
                    <td>
                        ...
                        <textarea class="form-control form-control-sm ta area_{{ $column }}" type="text" data-cell-name="item.{{ $column }}" cols="30" rows="4"></textarea>
                    </td>
                    @endforeach
                    <td>
            ...
            function bpFieldInitTableElement(element) {
                ...
                if($rows != '[]') {
                    $.each($rows, function(key) {
                        ...
                        $.each(this, function(column , value) {
                          //  $(".area_"+column).val(value);
                            $tableWrapper.find('tbody tr:last').find(".area_"+column).val(value);
                ...
                function updateTableFieldJson() {
                    ...
                    var tbl2 = $rows.each(function(i) {
                        x = $(this).children().closest('td').find('.ta');
                        var itArr = [];
                        x.each(function() {

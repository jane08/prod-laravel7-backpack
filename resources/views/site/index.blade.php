        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">{{ \App\Models\StaticTrans::t("main_title","Your Favorite Place for Free Bootstrap Themes",\App\Models\MenuItem::PAGE_MAIN) }}</h1>
                    <hr class="divider" />
                </div>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="mt-5">
                        <div class="mb-2"><img src="{{$benefit->image}}" alt=""></div>
                        <h3 class="h4 mb-2">{{$benefit->title}}</h3>
